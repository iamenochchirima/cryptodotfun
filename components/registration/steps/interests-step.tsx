...
const interestOptions = [
  ...
  { id: "nft", label: "NFT Marketplace", description: "Buying, selling, and creating NFTs" },
  { id: "tokens", label: "Token Launchpad", description: "Discovering and investing in new tokens" },
