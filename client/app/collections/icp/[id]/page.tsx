...
const collectionData = {
  id: "1",
  name: "ICP Pioneers",
  description: "An exclusive NFT collection on the Internet Computer Protocol, showcasing cutting-edge digital art stored entirely on-chain.",
  creator: "ICPCreator",
  creatorAddress: "abc123-xyz789-def456",
...
export default function ICPCollectionPage({ params }: { params: { id: string } }) {
