...
const collectionData = {
  id: "1",
  name: "Neo Tokyo",
  description: "A cyberpunk-inspired NFT collection on Solana, blending futuristic aesthetics with cutting-edge blockchain technology.",
  creator: "CyberArtist",
  creatorAddress: "So1ana...xyz123",
...
export default function SolanaCollectionPage({ params }: { params: { id: string } }) {
